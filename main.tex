...
\usepackage{svg}
\usepackage{placeins}
% Avoid stranding a subsection heading when its top-aligned figure moves to
% the next page. The paper has a single FloatBarrier, immediately after that
% figure, so normal float ordering is sufficient here.
